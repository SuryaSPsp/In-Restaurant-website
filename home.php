 <!-- Masthead-->
        ...
        <section class="home" id="home">
            <div class="container">
                <div class="home-wrapper d-grid">
                    <div class="col-left">
                        <h3>Welcome TO</h3>
                        <h1>In-Restaurant <br>Website</h1>

                        <p> We had dinner in the hotel's restaurant. The restaurant serves breakfast, lunch, and dinner. 
                            The food at the restaurant was good and the waiters were polite.</p>
                        <a href="#" class="btn">Order Now</a>

                    </div>
                    <div class="col-right">
                        <img data-tilt src="./assets/img/hero-img.png" alt="Home image" class="image img-fluid">
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-3" style="margin-bottom: 20px;">
                     <div class="card menu-item ">
                        ...
                        <div class="card-body">
                          ...
                          <h6 class="card-title">Price: Rs.<?php echo $row['price'] ?></h6>
    ...
    <style>
    .image  {
    animation: move 1.2s infinite ease-in-out alternate;
    }
@keyframes move{
    from{
